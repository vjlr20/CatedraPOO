...
public class JefesAreasMantenimiento extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form JefesAreasMantenimiento
     */
    public JefesAreasMantenimiento() throws SQLException {
        initComponents();
    ...
    public void listarJefesArea() throws SQLException {
        ...
        conex.setRs("SELECT usuarios.nombres, usuarios.apellidos, usuarios.usuario, usuarios.correo, DATE_FORMAT(usuarios.fecha_registro, '%d - %m -%Y') AS registro, estado_usuario.estado, usuarios.usuario_id FROM `usuarios` INNER JOIN estado_usuario ON usuarios.estado = estado_usuario.estado_usuario_id WHERE usuarios.tipo_usuario = 2 ORDER BY usuarios.usuario_id DESC");
    ...
    private void ingresoDatos(String[] nuevoJefe) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Jefe de Area Ingresado Exitosamente");
    ...
    private void borrarJefe(int id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Jefe de Area Eliminado Exitosamente");
    ...
    private void actualizarDatos(String[] updateJefe, boolean password) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Jefe de Area Actualizado Exitosamente");
